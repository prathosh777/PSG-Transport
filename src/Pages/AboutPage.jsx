...
//   return (
//     <div className="md:mt-28 w-[100%] mx-auto md:pb-40 min-h-screen">
//       {/* Header Section */}
...
//             <motion.span 
//               className="inline-block rounded-full bg-[#343434] px-4 text-white mb-6"
//               variants={itemVariants}
//             >
//               About us
//             </motion.span>
//             <motion.h1 
//               className="w-[60%] text-4xl md:text-5xl font-bold leading-tight mb-6"
//               variants={itemVariants}
//             >
