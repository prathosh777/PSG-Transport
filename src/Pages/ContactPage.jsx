...
//   return (
//     <div className=" md:min-h-screen w-[98%] mx-auto rounded-lg bg-[#101014] text-white flex items-center py-16 mb-3 md:py-24">
//       <div className="container mx-auto px-4 sm:px-6 lg:px-8">
//         {/* The `id="contact"` is added to the container for better anchor linking */}
//         <div
//           id="contact"
//           className="w-[94%] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16"
//         >
...
//             variants={staggerContainer}
//             className="lg:w-7/12 bg-[#16161a] p-8 sm:p-10 rounded-2xl shadow-2xl shadow-black/20"
//           >
